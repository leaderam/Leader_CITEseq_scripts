...
annots_list <- read.csv("tables/annots_list.csv",
...
dc1_mask <- v2_tissue_mask & annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"]=="cDC1"
 ...
 # mono_mask <- annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"]=="CD14 mono"
 # momac_mask <-  grepl("MoMac",annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"])
 # dc2_mask <- annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"]=="cDC2"
 # moDC_mask <-annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"]=="DC3"
 # dc1_mask <- annots_list[lung_ldm$dataset$cell_to_cluster,"sub_lineage"]=="cDC1"
...
cor.test(mono_score[moDC_mask],dc_score[moDC_mask],method="spearman")
cor.test(mono_score[dc2_mask],dc_score[dc2_mask],method="spearman")
